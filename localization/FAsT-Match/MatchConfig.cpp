...
namespace fast_match {
     ...
     * Copy constructor
     */
    MatchConfig::MatchConfig( const MatchConfig& object ) : id(object.getId()) {
    ...
    float MatchConfig::getTranslateX() const {
        return translateX;
    }

    float MatchConfig::getTranslateY() const {
        return translateY;
    }

    float MatchConfig::getProbability() const {
        return probability;
    }

    void MatchConfig::setProbability(float probability) {
        MatchConfig::probability = probability;
    }

    int MatchConfig::getId() const {
        return id;
    }

    void MatchConfig::setId(int id)  {
        MatchConfig::id = id;
    }
}
